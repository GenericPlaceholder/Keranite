...
public class ModEffects {
    ...
    public static final StatusEffect VANISHING = registerEffect("vanishing", new Vanishing(StatusEffectCategory.BENEFICIAL, 0xDBCA73));
    public static final StatusEffect OBFUSCATED = registerEffect("obfuscated", new Corrupted(StatusEffectCategory.NEUTRAL, 0x000000));
