...
public class ModBlocks {
    ...
    public static final Block RAW_KERANITE_BLOCK = registerBlock("raw_keranite_block", new RawKeranite(FabricBlockSettings.copyOf(Blocks.ANCIENT_DEBRIS).luminance(4)));
